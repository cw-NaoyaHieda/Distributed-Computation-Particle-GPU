...
auxiliary_particle_filtering<-function(data_for_Kalman,proposal_theta_m,sigma_1,sigma_2,sigma_3){
  N<<- 128
...
particle_smoothing<-function(data_for_Kalman,state_100,theta_100,sigma_1,sigma_2,sigma_3){
  N<-128
